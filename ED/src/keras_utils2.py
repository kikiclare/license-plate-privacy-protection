...
def reconstruct(Iorig,I,Y,out_size,Korig,threshold=.9):
	...
	if len(final_labels):
		...
		for i,label in enumerate(final_labels):
			...
			Ilp 	= cv2.warpPerspective(Korig,H,out_size,borderValue=.0)
...
def detect_lp(model,I,max_dim,net_step,out_size,threshold,K):
	...
	L,TLps = reconstruct(I,Iresized,Yr,out_size,K,threshold)
